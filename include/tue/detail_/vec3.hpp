...
namespace tue
{
    ...
    namespace detail_
    {
        ...
        sin_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::sin(v[0]),
                tue::math::sin(v[1]),
        ...
        cos_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::cos(v[0]),
                tue::math::cos(v[1]),
        ...
        exp_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::exp(v[0]),
                tue::math::exp(v[1]),
        ...
        log_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::log(v[0]),
                tue::math::log(v[1]),
        ...
        abs_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::abs(v[0]),
                tue::math::abs(v[1]),
        ...
        pow_xv(const T& base, const vec<U, 3>& exponents) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<U>())), 3>
        pow_vx(const vec<T, 3>& bases, const U& exponent) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<U>())), 3>
        pow_vv(const vec<T, 3>& bases, const vec<U, 3>& exponents) noexcept
        {
            return {
        ...
        recip_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::recip(v[0]),
                tue::math::recip(v[1]),
        ...
        sqrt_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::sqrt(v[0]),
                tue::math::sqrt(v[1]),
        ...
        rsqrt_v(const vec<T, 3>& v) noexcept
        {
            return {
                tue::math::rsqrt(v[0]),
                tue::math::rsqrt(v[1]),
        ...
        template<typename T>
        inline vec<T, 3>
        min_vv(const vec<T, 3>& v1, const vec<T, 3>& v2) noexcept
        {
            return {
        ...
        template<typename T>
        inline vec<T, 3>
        max_vv(const vec<T, 3>& v1, const vec<T, 3>& v2) noexcept
        {
            return {
        ...
        less_vv(const vec<T, 3>& lhs, const vec<U, 3>& rhs) noexcept
        {
            return {
        ...
        less_equal_vv(const vec<T, 3>& lhs, const vec<U, 3>& rhs) noexcept
        {
            return {
