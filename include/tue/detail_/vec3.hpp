...
namespace tue
{
    ...
    namespace detail_
    {
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 3>
        pow_xv(const T& base, const vec<T, 3>& exponents) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 3>
        pow_vx(const vec<T, 3>& bases, const T& exponent) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 3>
        pow_vv(const vec<T, 3>& bases, const vec<T, 3>& exponents) noexcept
        {
            return {
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::min(std::declval<T>(), std::declval<T>())), 3>
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::max(std::declval<T>(), std::declval<T>())), 3>
        ...
        template<typename T, typename U>
        inline vec<decltype(
            tue::math::select(std::declval<T>(), std::declval<U>())), 3>
        select_vv(
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::less(std::declval<T>(), std::declval<T>())), 3>
        less_vv(
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::less_equal(std::declval<T>(), std::declval<T>())), 3>
        less_equal_vv(
            const vec<T, 3>& lhs, const vec<T, 3>& rhs) noexcept
        {
            return {
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::greater(std::declval<T>(), std::declval<T>())), 3>
        greater_vv(
            const vec<T, 3>& lhs, const vec<T, 3>& rhs) noexcept
        {
            return {
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::greater_equal(std::declval<T>(), std::declval<T>())), 3>
        greater_equal_vv(
            const vec<T, 3>& lhs, const vec<T, 3>& rhs) noexcept
        {
            return {
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::equal(std::declval<T>(), std::declval<T>())), 3>
        equal_vv(
            const vec<T, 3>& lhs, const vec<T, 3>& rhs) noexcept
        {
            return {
        ...
        template<typename T>
        inline constexpr vec<decltype(
            tue::math::not_equal(std::declval<T>(), std::declval<T>())), 3>
        not_equal_vv(
            const vec<T, 3>& lhs, const vec<T, 3>& rhs) noexcept
        {
            return {
