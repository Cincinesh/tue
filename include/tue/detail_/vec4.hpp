...
namespace tue
{
    ...
    namespace detail_
    {
        ...
        template<typename T>
        inline constexpr vec<decltype(!std::declval<T>()), 4>
        logical_not_operator_v(const vec<T, 4>& v) noexcept
        {
            return { !v[0], !v[1], !v[2], !v[3] };
        }
        ...
        sin_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::sin(v[0]),
                tue::math::sin(v[1]),
        ...
        cos_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::cos(v[0]),
                tue::math::cos(v[1]),
        ...
        exp_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::exp(v[0]),
                tue::math::exp(v[1]),
        ...
        log_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::log(v[0]),
                tue::math::log(v[1]),
        ...
        abs_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::abs(v[0]),
                tue::math::abs(v[1]),
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 4>
        pow_xv(const T& base, const vec<T, 4>& exponents) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 4>
        pow_vx(const vec<T, 4>& bases, const T& exponent) noexcept
        {
            return {
        ...
        inline vec<decltype(
            tue::math::pow(std::declval<T>(), std::declval<T>())), 4>
        pow_vv(const vec<T, 4>& bases, const vec<T, 4>& exponents) noexcept
        {
            return {
        ...
        recip_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::recip(v[0]),
                tue::math::recip(v[1]),
        ...
        sqrt_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::sqrt(v[0]),
                tue::math::sqrt(v[1]),
        ...
        rsqrt_v(const vec<T, 4>& v) noexcept
        {
            return {
                tue::math::rsqrt(v[0]),
                tue::math::rsqrt(v[1]),
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::min(std::declval<T>(), std::declval<T>())), 4>
        min_vv(const vec<T, 4>& v1, const vec<T, 4>& v2) noexcept
        {
            return {
        ...
        template<typename T>
        inline vec<decltype(
            tue::math::max(std::declval<T>(), std::declval<T>())), 4>
        max_vv(const vec<T, 4>& v1, const vec<T, 4>& v2) noexcept
        {
            return {
        ...
        template<typename T, typename U>
        inline vec<decltype(
            tue::math::select(std::declval<T>(), std::declval<U>())), 4>
        select_vv(
