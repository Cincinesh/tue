...
namespace tue
{
    namespace detail_
    {
        ...
        {
            return {
                tue::detail_::matmult_component(lhs, rhs, i, 0),
                tue::detail_::matmult_component(lhs, rhs, i, 1),
            };
        }
            ...
            const mat<T, N, 3>& lhs, const mat<U, C, N>& rhs, int i) noexcept
        {
            return {
                tue::detail_::matmult_component(lhs, rhs, i, 0),
                tue::detail_::matmult_component(lhs, rhs, i, 1),
                tue::detail_::matmult_component(lhs, rhs, i, 2),
            };
        }
            ...
            const mat<T, N, 4>& lhs, const mat<U, C, N>& rhs, int i) noexcept
        {
            return {
                ...
                tue::detail_::matmult_component(lhs, rhs, i, 1),
                tue::detail_::matmult_component(lhs, rhs, i, 2),
                tue::detail_::matmult_component(lhs, rhs, i, 3),
            };
        }
        ...
        {
            return {
                tue::detail_::matmult_component(lhs, rhs, 0),
                tue::detail_::matmult_component(lhs, rhs, 1),
            };
        }
            ...
            const mat<T, N, 3>& lhs, const vec<U, N>& rhs) noexcept
        {
            return {
                tue::detail_::matmult_component(lhs, rhs, 0),
                tue::detail_::matmult_component(lhs, rhs, 1),
                tue::detail_::matmult_component(lhs, rhs, 2),
            };
        }
            ...
            const mat<T, N, 4>& lhs, const vec<U, N>& rhs) noexcept
        {
            return {
                ...
                tue::detail_::matmult_component(lhs, rhs, 1),
                tue::detail_::matmult_component(lhs, rhs, 2),
                tue::detail_::matmult_component(lhs, rhs, 3),
            };
        }
        ...
        {
            return {
                tue::detail_::matmult_column(lhs, rhs, 0),
                tue::detail_::matmult_column(lhs, rhs, 1),
            };
        }
            ...
            const mat<T, N, R>& lhs, const mat<U, 3, N>& rhs) noexcept
        {
            return {
                tue::detail_::matmult_column(lhs, rhs, 0),
                tue::detail_::matmult_column(lhs, rhs, 1),
                tue::detail_::matmult_column(lhs, rhs, 2),
            };
        }
            ...
            const mat<T, N, R>& lhs, const mat<U, 4, N>& rhs) noexcept
        {
            return {
                ...
                tue::detail_::matmult_column(lhs, rhs, 1),
                tue::detail_::matmult_column(lhs, rhs, 2),
                tue::detail_::matmult_column(lhs, rhs, 3),
            };
        }
    }
}
