...
TEST_CASE(select) {
  ...
  test_assert(math::select(v1, v2)
              == bool32x4(false32, false32, false32, false32));
  test_assert(math::select(v1, v3)
              == bool32x4(true32, false32, true32, false32));
  test_assert(math::select(v1, v4)
              == bool32x4(false32, true32, false32, true32));
  test_assert(math::select(v2, v3)
              == bool32x4(false32, false32, false32, false32));
  test_assert(math::select(v2, v4)
              == bool32x4(false32, false32, false32, false32));
  test_assert(math::select(v3, v4)
              == bool32x4(false32, false32, false32, false32));

  test_assert(math::select(v3, v1, v2)
              == bool32x4(true32, false32, true32, false32));
  test_assert(math::select(v3, v2, v1)
              == bool32x4(false32, true32, false32, true32));
  test_assert(math::select(v4, v1, v2)
              == bool32x4(false32, true32, false32, true32));
  test_assert(math::select(v3, v1, v2)
              == bool32x4(true32, false32, true32, false32));
}
