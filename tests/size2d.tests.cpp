...
TEST_CASE(explicit_conversion_constructor) {
  CONST_OR_CONSTEXPR dsize2d dsize(1.1, 2.2);
...
TEST_CASE(implicit_conversion_operator) {
  CONST_OR_CONSTEXPR fsize2d fsize(1.1f, 2.2f);
...
TEST_CASE(equality_operator) {
  CONST_OR_CONSTEXPR fsize2d s1(1.0f, 2.0f);
  CONST_OR_CONSTEXPR isize2d s2(1, 2);
  CONST_OR_CONSTEXPR isize2d s3(0, 2);
  CONST_OR_CONSTEXPR isize2d s4(1, 0);
