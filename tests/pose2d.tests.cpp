...
CONST_OR_CONSTEXPR fvec2 fv22(2.1f, 2.2f);
CONST_OR_CONSTEXPR fvec2 fv23(3.1f, 3.2f);
...
TEST_CASE(explicit_conversion_constructor) {
  CONST_OR_CONSTEXPR dpose2d dpose(dvec2(1.1, 2.2), 3.3);
...
TEST_CASE(implicit_conversion_operator) {
  CONST_OR_CONSTEXPR fpose2d fpose(fvec2(1.1f, 2.2f), 3.3f);
...
TEST_CASE(equality_operator) {
  CONST_OR_CONSTEXPR fpose2d p1(fvec2(1), 2);
  CONST_OR_CONSTEXPR fpose2d p2(fvec2(1), 2);
  CONST_OR_CONSTEXPR fpose2d p3(fvec2(0), 2);
  CONST_OR_CONSTEXPR fpose2d p4(fvec2(1), 0);
