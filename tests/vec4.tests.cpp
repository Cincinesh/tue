...
namespace
{
    ...
    TEST_CASE(size)
    {
        ...
        test_assert(sizeof(bvec4) == sizeof(bool) * 4);
    }
    ...
    TEST_CASE(alignment)
    {
        ...
        test_assert(alignof(uvec4) == alignof(unsigned int));
        test_assert(alignof(bvec4) == alignof(bool));
    }
    ...
    TEST_CASE(component_type)
    {
        ...
        test_assert((
            std::is_same<typename dvec4::component_type, double>::value));
        test_assert((
            std::is_same<typename ivec4::component_type, int>::value));
        test_assert((
            std::is_same<typename uvec4::component_type, unsigned int>::value));
        test_assert((
            std::is_same<typename bvec4::component_type, bool>::value));
    }
    ...
    TEST_CASE(pow)
    {
        const auto v1 = math::pow(
            2, dvec4(3.4, 5.6, 7.8, 9.10));
        test_assert(v1[0] == math::pow(2, 3.4));
        test_assert(v1[1] == math::pow(2, 5.6));
        test_assert(v1[2] == math::pow(2, 7.8));
        test_assert(v1[3] == math::pow(2, 9.10));

        const auto v2 = math::pow(
            dvec4(1.2, 3.4, 5.6, 7.8), 9);
        test_assert(v2[0] == math::pow(1.2, 9));
        test_assert(v2[1] == math::pow(3.4, 9));
        test_assert(v2[2] == math::pow(5.6, 9));
        test_assert(v2[3] == math::pow(7.8, 9));

        const auto v3 = math::pow(
            dvec4(1.2, 3.4, 5.6, 7.8), ivec4(9, 10, 11, 12));
        test_assert(v3[0] == math::pow(1.2, 9));
        test_assert(v3[1] == math::pow(3.4, 10));
        test_assert(v3[2] == math::pow(5.6, 11));
        test_assert(v3[3] == math::pow(7.8, 12));
    }
    ...
    TEST_CASE(recip)
    {
        ...
        test_assert(v[2] == math::recip(5.6));
        test_assert(v[3] == math::recip(7.8));
    }
    ...
    TEST_CASE(sqrt)
    {
        ...
        test_assert(v[2] == math::sqrt(5.6));
        test_assert(v[3] == math::sqrt(7.8));
    }
    ...
    TEST_CASE(rsqrt)
    {
        ...
        test_assert(v[3] == math::rsqrt(7.8));
    }
